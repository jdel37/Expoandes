  ...
  const renderAbstractShapes = () => {
        ...
        <Svg height={height} width={width} style={StyleSheet.absoluteFillObject}>
          <Defs>
            ...
            <SvgLinearGradient id="grad2" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <Stop offset="100%" stopColor={colors.accentLight} stopOpacity="0.03" />
            </SvgLinearGradient>
          </Defs>
          ...
          {/* Floating circles */}
          <Circle cx={width * 0.15} cy={height * 0.3} r="40" fill={colors.primary} opacity="0.1" />
          <Circle cx={width * 0.85} cy={height * 0.7} r="60" fill={colors.accent} opacity="0.08" />
          <Circle cx={width * 0.7} cy={height * 0.2} r="25" fill={colors.secondary} opacity="0.12" />
        </Svg>
      );
    }
    ...
    return (
      <Svg height={height} width={width} style={StyleSheet.absoluteFillObject}>
        <Defs>
          <SvgLinearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
            <Stop offset="0%" stopColor={colors.primaryLight} stopOpacity="0.15" />
            <Stop offset="100%" stopColor={colors.primary} stopOpacity="0.08" />
          </SvgLinearGradient>
          <SvgLinearGradient id="grad2" x1="0%" y1="0%" x2="100%" y2="100%">
            <Stop offset="0%" stopColor={colors.accent} stopOpacity="0.1" />
            <Stop offset="100%" stopColor={colors.accentLight} stopOpacity="0.05" />
          </SvgLinearGradient>
        </Defs>
        ...
        <Circle cx={width * 0.1} cy={height * 0.25} r="35" fill={colors.primary} opacity="0.12" />
        <Circle cx={width * 0.9} cy={height * 0.75} r="50" fill={colors.accent} opacity="0.1" />
        <Circle cx={width * 0.8} cy={height * 0.15} r="30" fill={colors.secondary} opacity="0.15" />
        <Circle cx={width * 0.2} cy={height * 0.8} r="40" fill={colors.primaryLight} opacity="0.08" />
      </Svg>
    );
  };
